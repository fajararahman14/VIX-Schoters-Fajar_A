package com.example.vix_schoters_fajar_a.data

import android.content.Context
import androidx.datastore.core.DataStore
import androidx.datastore.preferences.core.*
import androidx.datastore.preferences.preferencesDataStore
import com.example.vix_schoters_fajar_a.util.Constant.DEFAULT_CATEGORY
import com.example.vix_schoters_fajar_a.util.Constant.DEFAULT_COUNTRY
import com.example.vix_schoters_fajar_a.util.Constant.PREFERENCES_BACK_ONLINE
import com.example.vix_schoters_fajar_a.util.Constant.PREFERENCES_CATEGORY
import com.example.vix_schoters_fajar_a.util.Constant.PREFERENCES_CATEGORY_ID
import com.example.vix_schoters_fajar_a.util.Constant.PREFERENCES_COUNTRY
import com.example.vix_schoters_fajar_a.util.Constant.PREFERENCES_COUNTRY_ID
import com.example.vix_schoters_fajar_a.util.Constant.PREFERENCES_NAME
